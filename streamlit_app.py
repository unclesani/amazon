...
API_URL = "https://api.vectorengine.ai/v1/chat/completions"  # 你的 API 地址
...
if st.button("🚀 生成图片"):
    if not source_image:
        ...
        with st.spinner("AI 正在生成中..."):
            ...
            response = requests.post(https://api.vectorengine.ai/v1/chat/completions, files=files, data=data, headers=headers)
